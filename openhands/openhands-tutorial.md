...
| # | Section | Type |
|---|---|---|
| [1](#01-) | What Is OpenHands? — Architecture, Event Loop, Comparisons | CONCEPT |
| [2](#02-) | Installation & Setup — uv, Docker, Config, LLM Providers | SETUP |
| [3](#03-) | CLI Modes — TUI, Headless, Web, ACP, Cloud | DEMO |
| [4](#04-) | SDK Hello World — Your First Agent in Python | DEMO |
| [5](#05-) | Tools & Workspace — FileEditor, Terminal, WebBrowser, MCP | DEMO |
| [6](#06-) | Context Management & Skills — Condensers, AGENTS.md | DEMO |
| [7](#07-) | Security & Approval Modes — Analyzer, Risk Levels, Sandboxing | CONCEPT+DEMO |
| [8](#08-) | Agent Server — Remote Execution, REST/WebSocket API | DEMO |
| [9](#09-) | Headless Automation — CI/CD, GitHub Actions, Batch Jobs | DEMO |
| [10](#10-) | IDE Integration — ACP Protocol, JetBrains, VS Code, Zed | CONCEPT |
| [11](#11-) | Multi-Agent Orchestration — Task Decomposition, Parallel Agents | DEMO |
| [12](#12-) | Real-World Recipes — Bug Fix, Refactor, Tests, Migration | RECIPE |
| [13](#13-) | Appendix — Cheat Sheet, CLI Reference, Glossary | CONCEPT |

**Legend:**
- **CONCEPT** — Theory and architecture, no API key needed
...
This tutorial comes with companion files in the same directory:

```
openhands/
├── openhands-tutorial.md              ← This file (comprehensive reference)
├── configs/
│   ├── github-actions-autofix.yml     ← CI/CD workflow for GitHub Actions (Section 9)
│   ├── docker-compose-server.yml      ← Multi-service agent server (Section 8)
│   └── mcp-example.json              ← MCP server configuration (Section 5)
├── examples/
│   ├── 01_minimal_agent.py            ← Hello World agent (Section 4)
│   ├── 02_file_editor_demo.py         ← FileEditorTool examples (Section 5)
│   ├── 03_terminal_tool_demo.py       ← TerminalTool examples (Section 5)
│   ├── 04_custom_tool.py              ← Custom tool creation (Section 5)
│   ├── 05_condenser_demo.py           ← Condenser configuration (Section 6)
│   ├── 06_security_demo.py            ← Security analyzer patterns (Section 7)
│   ├── 07_agent_server_client.py      ← Remote agent SDK client (Section 8)
│   ├── 08_multi_agent_orch.py         ← Multi-agent orchestration (Section 11)
│   └── recipes/
│       ├── recipe1-bug-fix.sh
│       ├── recipe2-deps-update.sh
│       ├── recipe3-test-gen.sh
│       ├── recipe4-code-review.sh
│       ├── recipe5-scaffold.sh
│       └── recipe6-migration.sh
└── notebooks/                         ← Original .ipynb files (preserved)
```
...
<a id='03-'></a>
## 3. CLI Modes: TUI, Headless, Web, ACP, Cloud
...
<a id='04-'></a>
## 4. SDK Hello World: Your First Agent
...
<a id='05-'></a>
## 5. Tools & Workspace: The Agent's Hands and Desk
...
<a id='07-'></a>
## 7. Security Analyzer & Approval Modes
...
<a id='08-'></a>
## 8. Agent Server: Remote Execution
...
<a id='09-'></a>
## 9. Headless Automation: CI/CD & Scripting
